...
Deployment
Copy the files from this package into the matching locations in the existing website repository. Do not replace the homepage, gallery, training, news, or other V2 files. Then commit/push and redeploy on Vercel.
